...
为每个用户分配 m bit 的码片，并且所有的码片正交，对于任意两个码片 <img src="https://latex.codecogs.com/gif.latex?\vec{S}"/> 和 $\vec{T}$ 有
...
其中 <img src="https://latex.codecogs.com/gif.latex?\vec{S'}"/> 为 $\vec{S}$ 的反码。
